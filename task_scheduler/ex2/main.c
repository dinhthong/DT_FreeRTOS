/*
Task A with higher priority has 2 states. Running and Ready. But When Task A enters Ready it immediately switches
to Running state.
Task B doesn't have chance to do the job.
*/#include <stdio.h>
#include "stm32f4xx.h"
#include "FreeRTOS.h"
#include "task.h"
#define mainDELAY_LOOP_COUNT 500
